...
public class MainPagerAdapter extends PagerAdapter implements IconPagerAdapter {
	 ...
	 *            the adapter data
	 */
	public MainPagerAdapter(Context context, List<Post> adapterData) {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		Post currentProduct = mAdapterData.get(position);
		...
		mainLayout.setOnClickListener(new MainItemListener(mMainProductAdapter
				.exportAdapterDataAsList(), currentProduct.getPost_id(),
