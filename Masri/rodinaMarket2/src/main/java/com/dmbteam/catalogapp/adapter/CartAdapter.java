...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
	...
	public static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public ViewHolder(View itemView) {
			...
			qtytxt= (TextView) itemView
					.findViewById(R.id.qtyid);
		}
	}
	...
	public void onBindViewHolder(ViewHolder holder, int position) {
		...
		if(currentProduct.getPrice()==0){
			holder.priceDiscount.setVisibility(View.GONE);
			holder.priceRealUnderlined.setVisibility(View.GONE);
			holder.priceDiscount.setVisibility(View.GONE);
		...
		if(AppSettings.UseCart==0){
			...
			holder.imageViewPlus.setVisibility(View.GONE);
			holder.imageViewMinus.setVisibility(View.GONE);
			holder.qtytxt.setVisibility(View.GONE);
		}
