...
import static com.dmbteam.catalogapp.cmn.Post.isNetworkResource;
...
public class ItemsPhotoPagerAdapter extends PagerAdapter implements IconPagerAdapter{
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		if (Post.isNetworkResource(mAdapterData.get(position))) {
			...
			mainImageView.setImageDrawable(mContext.getResources().getDrawable(
					Post.getDrawableId(mContext, mAdapterData.get(position))));
		}
